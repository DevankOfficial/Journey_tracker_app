...
class JHome() {
    ...
    fun HomeScreen(navController: NavController){
        ...
        val background: Painter = painterResource(id = R.drawable.bg_1)
        ...
        Scaffold(
            ...
            Box(
                ...
                Column(modifier = Modifier.fillMaxHeight().padding(it)) {
                    Column(
                        modifier = Modifier
                            .padding(10.dp)
                            .fillMaxWidth()
    ...
    fun selectDes(onClickAction: () -> Unit): String {
        ...
        val places = listOf("Russia", "Canada", "South Africa", "Mumbai", "Kolkata")
